...
torch.save(model_ft.state_dict(), "trained_model_resnet_pick.pt")
...
plt.legend(loc='best')
plt.savefig('train_val_loss_plot_resnet_pick.png')
...
plt.legend(loc='best')
plt.savefig('train_val_acc_plot_resnet_pick.png')